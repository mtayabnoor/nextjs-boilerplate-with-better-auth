...
export type SubscriptionWhereInput = {
  ...
  nextBillingDate?: Prisma.DateTimeFilter<'Subscription'> | Date | string;
...
export type SubscriptionScalarWhereWithAggregatesInput = {
  ...
  nextBillingDate?: Prisma.DateTimeWithAggregatesFilter<'Subscription'> | Date | string;
};
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'userId' | 'name' | 'amount' | 'billingCycle' | 'nextBillingDate',
  ExtArgs['result']['subscription']
>;
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, SubscriptionGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors
